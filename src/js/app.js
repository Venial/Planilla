document.addEventListener("DOMContentLoaded", function () {
  ...
  let calendarioCargar, calendarioNueva;
  ...
  fechaPlanillaInput.value = todayFormatted;
  fechaDisplay.textContent = formatDate(todayFormatted);
  ...
  function nuevaPlanilla(fecha) {
    ...
    fechaDisplay.textContent = formatDate(fecha);
    limpiarDatos();
    return true;
  }
